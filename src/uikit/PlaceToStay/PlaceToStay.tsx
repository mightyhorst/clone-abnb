      ...
      <div className="PlaceToStay">
        ...
        <div className="place-to-stay__reviews">
          {noOfReviews && noOfReviews > 1 ? (
            <>
              <div className="place-to-stay__total-rating">{averageRating}</div>
        ...
        <div className="place-to-stay__details">
          <span className="place-to-stay__room">Hotel Room</span>
          <span> · </span>
          <span className="place-to-stay__beds">{noOfBeds} beds</span>
          <span> · </span>
